...
/* pseudo options */
        ...
        OPTKEEPQUIET,
/* (pseudo) shut up the message and refresh
 ...
 */
        ...
        char *filename;
/* when sending a message, this is the file
 * to which this structure refers
 */
        char *d_filename;
/* filename to be used for the
 ...
 */
        ...
        CONTENT *content;
/* structure used to store detailed info about
...
/* flag to indicate the the file named by
 ...
 */
        unsigned int is_signed_data : 1;
/* A lot of MUAs don't indicate
...
{
        unsigned int security : 11;
/* bit 0-6: flags, bit 7,8: application.
